...
class ActorsControllerTest < ActionController::TestCase
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post :create, actor: { age: @actor.age, bio: @actor.bio, genre_id: @actor.genre_id, movie_id: @actor.movie_id, name: @actor.name }
    end
  ...
  test "should update actor" do
    patch :update, id: @actor, actor: { age: @actor.age, bio: @actor.bio, genre_id: @actor.genre_id, movie_id: @actor.movie_id, name: @actor.name }
    assert_redirected_to actor_path(assigns(:actor))
  end
